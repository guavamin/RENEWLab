...
result = model_eval(test_data, params['SNR_dB_min'], params['SNR_dB_max'], mmse_accuracy, accuracy, batch_size, snr_db_min, snr_db_max, H, sess)
print(result)
path = 'result/OfflineTraining_%s_NT%sNR%s_%s/' %(args.modulation, args.x_size, args.y_size, args.linear)
...
# mpl.pyplot.xlabel('SNR(dB)')
# mpl.pyplot.ylabel('SER')
# mpl.pyplot.title('QAM_4')
